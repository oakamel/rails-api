...
ActiveRecord::Schema.define(version: 2021_02_03_064729) do
  ...
  create_table "messages", charset: "utf8mb4", force: :cascade do |t|
    ...
    t.index ["number", "application_id", "chat_id"], name: "index_messages_on_number_and_application_id_and_chat_id", unique: true
  end
